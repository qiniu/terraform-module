...
locals {
  runtime_paths = [
    ...
    "roles/deepseek_harness/files/dsh-auth-bootstrap/cordis.patch.yml",
    "roles/deepseek_harness/files/dsh-auth-bootstrap/lib/index.js",
    "roles/deepseek_harness/files/dsh-auth-bootstrap/package.json",
    ...
    "roles/deepseek_harness/tasks/uninstall_web_plugins.yml",
    "roles/deepseek_harness/templates/deepseek-harness.service.j2",
    "roles/deepseek_harness/templates/dsh-auth-bootstrap.env.j2",
    "roles/deepseek_harness/templates/dsh.env.j2",
    ...
    "roles/nginx/templates/dsh-auth-bootstrap-secret.conf.j2",
