...
locals {
  runtime_paths = [
    ...
    "roles/managed_skills/defaults/main.yml",
    "roles/managed_skills/tasks/main.yml",
    "roles/managed_skills/templates/las_dsh_environment/SKILL.md.j2",
    "roles/managed_skills/templates/las_static_preview/SKILL.md.j2",
    "roles/managed_skills/templates/las_static_preview/publish.sh.j2",
    "roles/managed_skills/templates/las_preview_ports/SKILL.md.j2",
    "roles/managed_skills/templates/las_preview_ports/manage-preview-port.sh.j2",
