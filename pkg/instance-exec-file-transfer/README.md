...
| 内容大小 | 路径 | 说明 |
| --- | --- | --- |
| base64 payload ≤ 92600 字节 | `modules/direct` | 单条命令直传（staging/marker + SHA 校验 + 同目录原子 mv） |
...
| `chunk_size` | number | `95000` | 分片 payload 上限（字节，按 4 对齐） |
